...
|               | Moov          | NO                                    | À composer après réception du SMS de débit               |
...
|               | Expresso      | _\*444_\*3\*3#                        | À composer après réception du SMS de débit               |
...
| Guinée        | Orange        | #144#, choisir l'option 4 puis l'option 2 | Payment by OTP code                                 |
|               | Mtn           | NO                                    | Confirmation by secret code after receiving the push sms |
