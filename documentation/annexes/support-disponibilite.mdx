...
description: "Canaux de support, SLA et disponibilité de l'API KAYBIC AFRICA "
icon: "headset"
---
...
| ----------------------- | ------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| **Email support**       | Pour toutes questions techniques sur l'API, incidents ou bugs | [support-business@KAYBIC AFRICA.ci](support-business@KAYBIC AFRICA.ci) – 24/7 |
| **Portail développeur** | Documentation complète, FAQs, tickets de support et guides    | https://KAYBIC AFRICA.mintlify.app/ – 24/7                                    |
