...
- Type: Ce champ reprense le moyen par lequel vous voulez recevoir les fonds. Il en existe deux `Virement bancaire` et `Mobile money`
- Montant: Le montant que vous souhaitez récuperer

  <Note>
    Assuez vous de saisir un montant valide en fonction de ce que vous avez sur votre compte
  </Note>
