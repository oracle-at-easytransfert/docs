...
Il n'existe pas de méthode spécifique pour configurer les webhooks, l'IPN est transféré directement dans [la requête pendant l'initialisation de la transaction](/api-reference/endpoint/transaction).